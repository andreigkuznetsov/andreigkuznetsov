...
<b>QA Engineer с 6+ годами опыта в web и mobile тестировании и 2+ годами в автоматизации на 
Java. Специализируюсь на API-тестировании (REST), UI-регрессии (Selenide), тест-дизайне и анализе 
требований. Оптимизирую QA-процессы: внедрил API/UI автотесты, что сократило время регресса 
на 50% и ускорило поставку релизов на 10%. Заинтересован в расширении технической 
экспертизы – от Manual QA до FullStack QA, при этом готов решать задачи бизнеса на разных 
уровнях QA. </b>
